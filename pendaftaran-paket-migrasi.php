        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              $id = $_GET['id'];
              $data   = mysqli_query($koneksi, "select pendaftaran.*, pelanggan.kode, pelanggan.nik, pelanggan.hp, pelanggan.nama,pelanggan.alamat,pelanggan.status_rumah, paket.nama as nama_paket from pendaftaran JOIN pelanggan ON pelanggan.id = pendaftaran.pelanggan_id join paket on paket.id = pendaftaran.paket_id group by pendaftaran.id");
                    ...
                    ?>
                     <form action="" method="post" role="form" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="id" required="" class="form-control col-sm-4" autofocus value="<?= $row['pelanggan_id']; ?>" readonly="true" >
                        </div>
                        <div class="form-group">
...
//         } else {
          ...
          $datas2 = mysqli_query($koneksi, "insert into pendaftaran (pelanggan_id,no_psb,no_internet,no_voice,paket_id,tgl_psb,status_pemasangan,jenis_psb)values('$id','$no_psb','$no_internet','$no_voice','$paket_id','$tgl_psb','$status_pemasangan','$jenis_psb')") or die(mysqli_error($koneksi));
